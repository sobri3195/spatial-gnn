...
DROP TYPE IF EXISTS public.tissue_type CASCADE;
...
DROP TABLE IF EXISTS public.gene_expressions CASCADE;
DROP TABLE IF EXISTS public.genes CASCADE;
DROP TABLE IF EXISTS public.st_data_points CASCADE;
DROP TABLE IF EXISTS public.wsi_images CASCADE;
